...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/google-cloud-compute-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14530&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/google-cloud-compute-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `google-cloud-compute` can be installed with:

```
conda install google-cloud-compute
```

It is possible to list all of the versions of `google-cloud-compute` available on your platform with:
